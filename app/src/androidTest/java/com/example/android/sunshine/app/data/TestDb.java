...
public class TestDb extends AndroidTestCase {
    ...
    */
    ...
    public void testWeatherTable() {
        ...
        assertTrue("Error: no weather entries in the database", cursor.moveToFirst());

        // Validate data in resulting Cursor with the original ContentValues
        // (you can use the validateCurrentRecord function in TestUtilities to validate the
        // query if you like)
        TestUtilities.validateCurrentRecord("Error: Weather record not in the database.", cursor, weatherValues);
    ...
    public long insertLocation() {
        ...
        // Insert ContentValues into database and get a row ID back
        long newId = db.insert(WeatherContract.LocationEntry.TABLE_NAME, null, testValues);
        // make sure that the row was inserted.
        assertTrue(newId != -1L);
        ...
        assertFalse("Error: There is more than one record in the location table", cursor.moveToNext());
